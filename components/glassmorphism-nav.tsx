...
const navigation = [
  ...
  { name: "Project Showcase", href: "#case-studies" },
    ...
    <>
      ...
      >
        ...
        <div className="w-[90vw] max-w-xs md:max-w-4xl mx-auto">
          <div className="bg-emerald-500/10 backdrop-blur-md border border-emerald-200/30 rounded-full px-4 py-3 md:px-6 md:py-2 shadow-[0_8px_30px_rgba(0,106,84,0.25)]">
            <div className="flex items-center justify-between">
              ...
              >
                <div className="h-8 w-8 sm:h-9 sm:w-9 md:h-10 md:w-10 lg:h-11 lg:w-11 flex items-center justify-center">
                  <Image
        ...
        <div className="md:hidden relative">
          ...
          >
            <div className="bg-emerald-500/10 backdrop-blur-md border border-emerald-200/30 rounded-2xl p-4 shadow-[0_10px_35px_rgba(0,106,84,0.3)]">
              <div className="flex flex-col space-y-1">
                {navigation.map((item, index) =>
                  item.href.startsWith("/") ? (
                    <Link
                      key={item.name}
                      href={item.href}
                      className={`text-white/80 hover:text-white hover:bg-emerald-400/20 rounded-lg px-3 py-3 text-left transition-all duration-300 font-medium cursor-pointer transform hover:scale-[1.02] hover:translate-x-1 ${
                ...
                <div className="h-px bg-emerald-200/20 my-2" />
                <button
