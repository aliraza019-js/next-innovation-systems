...
const AnimatedChatDemo = ({ isActive }: { isActive: boolean }) => {
  const [messages, setMessages] = useState([
    { text: "Hi! How can I support your project today?", isBot: true, visible: false },
    { text: "We need help with cloud migration", isBot: false, visible: false },
  ...
  useEffect(() => {
    ...
    const scenarios = [
      [
        { text: "Hi! How can I support your project today?", isBot: true },
        { text: "We need help with cloud migration", isBot: false },
        { text: "Perfect. I can route you to our cloud solutions team now.", isBot: true },
      ],
      [
        { text: "Hello! I'm available 24/7 to assist your team.", isBot: true },
        { text: "Can you build a dedicated engineering team?", isBot: false },
        { text: "Absolutely. We can assemble a dedicated team quickly.", isBot: true },
      ],
      [
        { text: "Good evening! How may I assist your business?", isBot: true },
        { text: "We need AI/ML for process automation", isBot: false },
        { text: "Great. I'll collect your use case and book a consultation.", isBot: true },
      ],
    ]
...
const AnimatedCalendarDemo = ({ isActive }: { isActive: boolean }) => {
  ...
  return (
    <div className="bg-slate-50 rounded-lg p-4 h-32">
      ...
      {booked && (
        <div className="mt-2 text-xs text-green-600 font-medium animate-fade-in">✓ Strategy call booked for the 15th</div>
      )}
    </div>
  )
}
...
const AnimatedEmailDemo = ({ isActive }: { isActive: boolean }) => {
  const [emails, setEmails] = useState([
    { subject: "Cloud migration inquiry", status: "unread" },
    { subject: "AI/ML discovery call", status: "unread" },
    { subject: "DevOps implementation quote", status: "unread" },
  ])
...
const AnimatedLeadsDemo = ({ isActive }: { isActive: boolean }) => {
  const [leads, setLeads] = useState([
    { name: "FinCo", score: 0, qualified: false },
    { name: "RetailX", score: 0, qualified: false },
    { name: "Health+", score: 0, qualified: false },
  ])
...
const features = [
  {
    ...
    description:
      "Tailored software solutions designed around your workflows to increase efficiency and unlock business growth.",
  ...
  },
  {
    ...
    description:
      "Seamless migration, management, and cloud optimization to scale infrastructure with security and control.",
  ...
  },
  {
    ...
    description:
      "Practical AI/ML systems that automate operations and improve decision-making with measurable outcomes.",
  ...
  },
  {
    ...
    description:
      "Native and cross-platform mobile applications built for performance, reliability, and exceptional UX.",
  ...
  },
  {
    title: "UI/UX Design",
    description:
      "Intuitive interfaces and product experiences designed to boost adoption, engagement, and conversion.",
  ...
  },
  {
    title: "DevOps & SecOps",
    description:
      "Streamlined CI/CD and robust security practices that accelerate releases while protecting your assets.",
        ...
        <div className="max-w-7xl mx-auto relative">
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-slate-600 max-w-3xl mx-auto font-light leading-relaxed">
              From custom software to cloud, AI/ML, mobile, and DevOps, we deliver end-to-end solutions for digital
              transformation.
            </p>
          </div>
