  ...
  const benefits = [
    {
      ...
      description:
        "NIS Assistant responds to 50+ common questions about NCT, mileage, trade-ins, and pricing instantly across your website, phone, and social channels",
    },
    {
      title: "Qualify Leads",
      description:
    ...
    {
      title: "Save Time",
      description: "Stop answering the same questions repeatedly - let NIS Assistant handle the tire kickers",
    },
    {
